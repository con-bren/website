...
<center>![](files/images/MethodOverview.png){}</center>

<br>
<br>

<h3>Modeling <i>C. elegans</i> nervous system.</h3>
Application of LOOPER-like analysis to nematode <i>C. elegans</i> results in a model of nervous system dynamics that allows for predictions of future animal behaviors.

<center>![](files/images/WormModel2.png){}</center>
